...
//  Swift Radio
//
//  Created by Zoe Sheill on 7/22/15.
...
class NowPlayingViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        aboutUsButton.contentMode = UIViewContentMode.scaleAspectFit
        ...
        if newStation {
            ...
            updateLabels()
            albumImageView.image = /*track.artworkImage*/ UIImage(named: "KMIH-thebridge")
    ...
    func stationDidChange() {
        ...
        radioPlayer.contentURL = URL(string: "http://stream-high.kmih.org:8000/")
        radioPlayer.prepareToPlay()
        radioPlayer.play()
    ...
    func updateLabels(statusMessage: String = "") {
       ...
       /* if track.artworkLoaded || iPhone4 {
            ...
            stationDescLabel.text = "Hot Jamz is KMIH FM Radio, heard in the Seattle area at 88.9 and 94.5 FM. The programming is generated by the students of Mercer Island High School in Mercer Island, Washington. Thanks for listening! "
        }*/
    }
    ...
    func resetAlbumArtwork() {
        ...
        track.artworkURL = "KMIH-thebridge"
        updateAlbumArtwork()
       // stationDescLabel.isHidden = false
    }
    ...
    @IBAction func shareButtonPressed(_ sender: UIButton) {
        let songToShare = "I'm listening to \(track.title) on KMIH Radio via KMIH Radio App"
